...
public class AnimalDataset extends RandomAccessDataset {
    private final List<Path> imagePaths;
    private final List<Integer> labels;
    public static final int IMAGE_WIDTH = 150;
    public static final int IMAGE_HEIGHT = 150;

    private AnimalDataset(Builder builder) {
        super(builder);
...
//        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%");
//        System.out.println("imagePath = " + imagePath.toFile().getAbsolutePath());
